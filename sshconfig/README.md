...
<div align="center">
<img align="center" width="600" src="./img/screen03.webp">
</div>
<br>
...
Unter Linux (GNOME/Arch) werden Informationen zu den SSH-Verbindungen in zwei verschiedenen Bereichen des Schlüsselbunds verwaltet:

### 1\. OpenSSH-Schlüsselbund (Automatische Erkennung)

In diesem Bereich werden Einträge **automatisch** erstellt. Der GNOME Keyring-Daemon scannt das Verzeichnis `~/.ssh` nach privaten Schlüsseln. Sobald dort ein gültiger Key liegt, wird er im Schlüsselbund angezeigt.

Der Eintrag selbst wird nicht direkt durch das Kopieren der Datei erzeugt, sondern durch ein Systemereignis (z. B. das Einloggen in die Session, das Öffnen von Seahorse oder den ersten SSH-Aufruf) getriggert.

<p align="center"\>
<img src="img/screen01.webp" alt="OpenSSH-Schlüsselbund" width="800"\>
</p\>

### 2\. Standard-Schlüsselbund (Passphrasen-Speicher)

Im Standard-Schlüsselbund (meist „Anmeldung“, „Login“ oder „Default“) soll es für jeden mit einer Passphrase verschlüsselten Key ein eigenen Eintrag geben. Hierbei handelt es sich um die **Passphrase des private Keys**, die beim Erzeugen des key Paares festgelehgt wurde und bei einer SSH- oder Git-Verbindung abgefragt wird.

Diese Einträge werden durch das Skript aktiv in den Keyring geschrieben, damit die Passphrase nicht bei jeder Verbindung manuell eingegeben werden muss.

<p align="center"\>
<img src="img/screen02.webp" alt="Standard-Schlüsselbund" width="800"\>
</p\>
...
1. **Pfad zum Stick:**
    ...
    Prüfen, wo der Stick eingehängt (gemountet) ist.
...
Wenn der Testlauf sauber durchläuft, das Skript _hot_ starten lassen:

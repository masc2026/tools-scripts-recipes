...
**Beispiel `evtest` - Apple MacBook Pro 2015 mit `debian`**:

```bash
user@debianmac:~$ sudo evtest             
...
...
Event: time 1767683962.599398, -------------- SYN_REPORT ------------
...
Event: time 1767683962.879406, -------------- SYN_REPORT ------------
...
**Beispiel `evtest` - PC Hardware mit `arch`**:
```bash
user@archpc ~ % sudo evtest
No device specified, trying to scan all of /dev/input/event*
Available devices:
...
...
Testing ... (interrupt to exit)
...
Event: time 1767684112.625304, -------------- SYN_REPORT ------------
...
Event: time 1767684113.769284, -------------- SYN_REPORT ------------
